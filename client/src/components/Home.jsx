    ...
    return (
      ...
      {/* Container */}
            <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
                    <p className='text-8xl font- text-yellow-300 animate__animated animate__fadeInDown animate__delay-1s'>It's Time For</p>
                    <h1 className='text-9xl font-bold text-[#f99cf6] animate__animated animate__backInDown animate__delay-2s'>Whatchoo Know 'Bout Me?!</h1>
